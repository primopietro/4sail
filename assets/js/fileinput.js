...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tActionZoom = '<button type="button" class="fa fa-search" ' +
        ...
        _listenFullScreen: function (isFullScreen) {
            ...
            if ($modal.hasClass('fa-arrows-alt')) {
            ...
            if ($modal.hasClass('fa-arrows-alt')) {
                ...
                if (!fullScreen) {
                    if (!$btnFull.hasClass('active')) {
                        $modal.removeClass('fa-arrows-alt');
        ...
        _initZoomButton: function () {
            var self = this;
            self.$preview.find('.fa-search').each(function () {
                var $el = $(this);
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonClasses: {
            ...
            borderless: 'btn btn-kv btn-default btn-outline-secondary none',
        ...
        browseClass: 'btn btn-fill',
        removeIcon: '<i class="fa fa-trash"></i>',
        removeClass: 'btn btn-fill',
